...
exports.SincroExtractor = void 0;
 ...
 */
class SincroExtractor extends BaseExtractor_1.BaseExtractor {
    ...
    async extractFromPriceStack(responses) {
        const listings = [];
...
exports.SincroExtractor = SincroExtractor;
